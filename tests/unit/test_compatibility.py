...
@pytest.mark.parametrize(
    "stored_record, expected_record, env_id, password", [PREPARED_PAYLOAD],
)
...
def test_dec_stored_data(stored_record, expected_record, env_id, password):
    ...
    assert omit(decrypted_record, "version") == expected_record
...
def test_enc_data(stored_record, expected_record, env_id, password):
    ...
    assert omit(encrypted_record, "body") == omit(stored_record, "body")
